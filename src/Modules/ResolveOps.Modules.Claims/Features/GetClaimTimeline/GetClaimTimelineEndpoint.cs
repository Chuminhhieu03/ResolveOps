...
public sealed class GetClaimTimelineEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet("/api/claims/{claimId:guid}/timeline", async (
            Guid claimId,
            IValidator<GetClaimTimelineQuery> validator,
            GetClaimTimelineHandler handler,
            CancellationToken cancellationToken) =>
        {
            var query = new GetClaimTimelineQuery(claimId);
