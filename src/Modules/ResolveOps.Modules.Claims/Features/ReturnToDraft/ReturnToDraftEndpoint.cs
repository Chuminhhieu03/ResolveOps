...
public sealed class ReturnToDraftEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/claims/{claimId:guid}/return-to-draft", async (
            Guid claimId,
            [FromBody] ReturnToDraftRequest request,
            IValidator<ReturnToDraftCommand> validator,
            ReturnToDraftHandler handler,
