...
namespace ResolveOps.Persistence.Migrations
{
    ...
    [Migration("20260923151333_AddReportingAndCarrierScorecards")]
    partial class AddReportingAndCarrierScorecards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResolveOps.Domain.Claims.Claim", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ApprovedForSubmissionAtUtc")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("approved_for_submission_at_utc");

                    b.Property<Guid?>("ApprovedForSubmissionBy")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("approved_for_submission_by");
                    ...
                    b.Property<DateTimeOffset?>("ClaimDeadlineAtUtc")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("claim_deadline_at_utc");
                    ...
                    b.Property<string>("EligibilityReasonCodes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("eligibility_reason_codes");
                    ...
                    b.Property<string>("ExternalSubmissionReference")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("external_submission_reference");
                    ...
                    b.Property<DateTimeOffset?>("WrittenOffAtUtc")
                        .HasColumnType("datetimeoffset")
                        .HasColumnName("written_off_at_utc");
            ...
            modelBuilder.Entity("ResolveOps.Domain.Claims.ClaimLossComponent", b =>
                {
                    ...
                    b.ToTable("claim_loss_components", (string)null);
                });

            modelBuilder.Entity("ResolveOps.Domain.Claims.RecoveryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("recovery_transactions", (string)null);
                });

            modelBuilder.Entity("ResolveOps.Domain.Documents.EvidenceDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "Status", "UploadedAtUtc")
                        .HasDatabaseName("ix_evidence_documents_tenant_status_uploaded");

                    b.HasIndex("TenantId", "CaseId", "EvidenceType", "Status")
                        .HasDatabaseName("ix_evidence_documents_tenant_case_type_status");

                    b.ToTable("evidence_documents", (string)null);
                });

            modelBuilder.Entity("ResolveOps.Domain.Documents.EvidenceRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "ExceptionType", "EvidenceType")
            ...
            modelBuilder.Entity("ResolveOps.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("NotificationClass")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("notification_class");
            ...
            modelBuilder.Entity("ResolveOps.Domain.Notifications.NotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("ResolveOps.Domain.Notifications.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("TenantId", "UserId", "NotificationClass", "Channel")
                        .IsUnique()
            ...
            modelBuilder.Entity("ResolveOps.Domain.Notifications.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("TenantId", "TemplateCode", "Channel", "Version")
                        .IsUnique()
            ...
            modelBuilder.Entity("ResolveOps.Domain.Reporting.CarrierPerformanceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("CriticalSeverityCount")
                        .HasColumnType("int")
                        .HasColumnName("critical_severity_count");

                    b.Property<int>("DelayedShipments")
                        .HasColumnType("int")
                        .HasColumnName("delayed_shipments");
                    ...
                    b.Property<int>("HighSeverityCount")
                        .HasColumnType("int")
                        .HasColumnName("high_severity_count");
                    ...
                    b.Property<int>("LowSeverityCount")
                        .HasColumnType("int")
                        .HasColumnName("low_severity_count");

                    b.Property<int>("MediumSeverityCount")
                        .HasColumnType("int")
                        .HasColumnName("medium_severity_count");

                    b.Property<int>("OnTimeShipments")
                        .HasColumnType("int")
                        .HasColumnName("on_time_shipments");
                    ...
                    b.Property<decimal>("TotalClaimedAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)")
                        .HasColumnName("total_claimed_amount");
                    ...
                    b.Property<decimal>("TotalRecoveredAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)")
                        .HasColumnName("total_recovered_amount");

                    b.Property<int>("TotalShipments")
                        .HasColumnType("int")
                        .HasColumnName("total_shipments");
                    ...
                    b.HasIndex("TenantId", "PeriodDate")
                        .HasDatabaseName("ix_carrier_performance_snapshots_tenant_period");

                    b.HasIndex("TenantId", "CarrierId", "PeriodDate")
                        .IsUnique()
                        .HasDatabaseName("ix_carrier_performance_snapshots_tenant_carrier_period");

                    b.ToTable("carrier_performance_snapshots", (string)null);
                });

            modelBuilder.Entity("ResolveOps.Domain.Reporting.ExportRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("ResolveOps.Domain.Claims.ClaimLossComponent", b =>
                {
                    b.HasOne("ResolveOps.Domain.Claims.Claim", null)
                        .WithMany("LossComponents")
                        .HasForeignKey("ClaimId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("ResolveOps.Domain.Claims.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<Guid>("ClaimLossComponentId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("claim_loss_component_id");
                            ...
                            b1.HasKey("ClaimLossComponentId");

                            b1.ToTable("money");

                            b1.WithOwner()
                                .HasForeignKey("ClaimLossComponentId");
                        });
            ...
            modelBuilder.Entity("ResolveOps.Domain.Claims.Claim", b =>
                {
                    ...
                    b.Navigation("RecoveryTransactions");
